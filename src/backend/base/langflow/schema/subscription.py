...
class SubscriptionCreate(BaseModel):
    ...
    cancel_at: Optional[str] = Field(default=None, description="Timestamp of when the subscription will be canceled")
    cancel_at_period_end: Optional[bool] = Field(default=None, description="Whether the subscription will be canceled at the end of the period")
    canceled_at: Optional[str] = Field(default=None, description="Timestamp of when the subscription was canceled")
    ...
    ended_at: Optional[str] = Field(default=None, description="Timestamp of when the subscription ended")
    id: str = Field(..., description="Unique identifier for the subscription")
    stripe_metadata: Optional[Dict[str, Any]] = Field(default=None, description="Set of key-value pairs for storing additional information")
    price_id: Optional[str] = Field(default=None, description="ID of the price associated with this subscription")
    quantity: Optional[int] = Field(default=None, description="Quantity of the subscribed product")
    status: SubscriptionStatus = Field(..., description="Current status of the subscription")
    trial_end: Optional[str] = Field(default=None, description="End date of the trial period")
    trial_start: Optional[str] = Field(default=None, description="Start date of the trial period")
