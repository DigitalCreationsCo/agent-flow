...
async def create_subscription(session: AsyncSession, subscription_create: SubscriptionCreate) -> SubscriptionRead:
...
async def update_subscription(
    session: AsyncSession, subscription_id: UUID, subscription_update: SubscriptionUpdate
