...
output AZURE_RESOURCE_BASE_ID string = resources.outputs.AZURE_RESOURCE_BASE_ID
output AZURE_RESOURCE_REDIS_ID string = resources.outputs.AZURE_RESOURCE_REDIS_ID
output AZURE_RESOURCE_LANGFLOW_ID string = resources.outputs.AZURE_RESOURCE_LANGFLOW_ID
